package com.baway.myapplication.activities;
...
import com.baway.myapplication.R;
import com.baway.myapplication.adapter.RefreshLoadMoreRecycleAdapter;
import com.baway.myapplication.widget.SpacesItemDecoration;
...
public class RefreshLoadMoreGridActivity extends Activity implements RefreshLoadMoreRecycleView.IOnScrollListener{
    ...
    public void onLoaded() {
        Toast.makeText(RefreshLoadMoreGridActivity.this,getString(R.string.app_name),Toast.LENGTH_SHORT).show();
    }
